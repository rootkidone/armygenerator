...
public class TroopManagerTest {
	...
	public void test_add_troop_spearmen() {
		...
		Integer archers = manager.getTroopManagementMap().get(TroopEnum.SPEARMAN);
		Assertions.assertThat(archers).isEqualTo(numberOfSpearman);
	}
	...
	public void test_add_troop_swordsman() {
		...
		Integer archers = manager.getTroopManagementMap().get(TroopEnum.SWORDMAN);
		Assertions.assertThat(archers).isEqualTo(numberOfSwordmen);
	}
}
